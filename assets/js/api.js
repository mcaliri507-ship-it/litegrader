    ...
    banner.innerHTML = `
      <div class="flex items-start">
        ...
        <div>
          ...
          <p>This is a preview of the reseller website template. <a href="https://upgrader.cc/api/download-reseller-package" download="reseller-website.zip" class="underline font-semibold">Download the package</a> and configure your API key to use all features.</p>
        </div>
      </div>
    `;
    return banner;
